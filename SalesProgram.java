...
class Book extends Publication {
    ...
    public double saleCopy(int quantity) {
        if (quantity <= getCopies()) {
            ...
            return getPrice() * quantity * 0.9; // 10% discount for books
        } else {
            return 0.0;
        }
    }
...
class Magazine extends Publication {
    ...
    public double saleCopy(int quantity) {
        if (quantity <= getCopies()) {
            ...
            availableCopies -= quantity;
            setCopies(availableCopies);
            return getPrice() * quantity; // No discount for magazines
        } else {
            return 0.0;
        }
    }
...
public class SalesProgram {
    public static void main(String[] args) {
        ...
        // Selling copies using overridden methods
        ...
        // Similar code for selling magazines using the overridden method
        System.out.println("\nMagazine Details:");
        ...
        // Calculate and display total publication sales
